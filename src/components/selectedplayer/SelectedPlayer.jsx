    ...
    return (
        <div>
            <div className='flex justify-between border border-gray-300 mt-5 p-6 rounded-2xl'>
                ...
                <button onClick={() => {handleRemoveButton(id); toast.info(`${player_name} removed`, {position:'top-center'})}} ><a onClick={(e) => e.preventDefault()} href="#"><MdDeleteForever className="text-red-300 hover:text-red-500 text-3xl" /></a></button>
            </div>
        </div>
    );
};
